...
func TestDeltaE(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Black Δ Lime", args: args{lab1: Black.Lab, lab2: Lime.Lab}, want: 148.47163136},
		...
		{name: "White Δ Lime", args: args{lab1: White.Lab, lab2: Lime.Lab}, want: 120.39770828},
		...
		{name: "Red Δ Lime", args: args{lab1: Red.Lab, lab2: Lime.Lab}, want: 170.56559542},
		{name: "Lime Δ Blue", args: args{lab1: Lime.Lab, lab2: Blue.Lab}, want: 258.68020299},
...
func TestDeltaE94(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "White Δ Lime", args: args{lab1: White.Lab, lab2: Lime.Lab}, want: 120.36950583},
		...
		{name: "White Δ White", args: args{lab1: White.Lab, lab2: White.Lab}, want: 0.00000000},
		{name: "Red Δ Lime", args: args{lab1: Red.Lab, lab2: Lime.Lab}, want: 73.43089410},
		{name: "Lime Δ Blue", args: args{lab1: Lime.Lab, lab2: Blue.Lab}, want: 105.90485427},
